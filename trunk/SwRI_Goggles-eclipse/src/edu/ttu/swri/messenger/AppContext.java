...
public class AppContext extends Application {
	...
	public void onCreate() {
		...
		AppContext.current_user_name = "GogglesDemo";// settings.getString("selectedUser",
														// "Goggles_UI");
		// AppContext.currrent_user_friend =
		// getResources().getString(R.string.current_user_friend);

		String locationString = settings
				.getString(
						AppContext.current_user_name,
						"{\"description\":\"\",\"name\":\"Alex\",\"longitude\":-98.311491,\"latitude\":26.23413147,\"id\":\"cb08ba625f0009c6\",\"lastUpdate\":\"May 7, 2013 4:27:40 AM\",\"type\":\"T_MATE\"}");
		if (locationString != null) {
			AppContext.currentUserLatestLocation = gson.fromJson(
					locationString, ElementMate.class);
		}

		locationString = settings.getString(AppContext.currrent_user_friend,
				null);
		if (locationString != null) {
			AppContext.currentUserFriendLatestLocation = gson.fromJson(
					locationString, ElementMate.class);
		}
		...
		uniqueDeviceId = Secure.getString(getApplicationContext()
	...
	public static void setCurrentUserLatestLocation(
		...
		settings.edit().putString(AppContext.current_user_name,
				gson.toJson(currentUserLatestLocation));
	...
	public static void setCurrentUserFriendLatestLocation(
		...
		settings.edit().putString(AppContext.currrent_user_friend,
				gson.toJson(currentUserFriendLatestLocation));
	}
